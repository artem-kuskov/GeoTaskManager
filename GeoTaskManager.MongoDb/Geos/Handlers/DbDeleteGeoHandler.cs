...
{
    internal class DbDeleteGeoHandler
        : IRequestHandler<DbDeleteCommand<Geo>,
            DeleteResult>
    {
        private ILogger<DbDeleteGeoHandler> Logger { get; }
        private MongoDbContext DbContext { get; }

        public DbDeleteGeoHandler(ILogger<DbDeleteGeoHandler> logger,
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                var validation = new DbDeleteCommandValidator<Geo>()
                    .Validate(request);
